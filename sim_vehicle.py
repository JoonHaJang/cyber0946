...
def kill_tasks():
    ...
    print("second called function is kill_tasks()")
...
def get_user_locations_path():
    ...
    print("1.get_user_locations_path() is called for user location path finding!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1!")
    print(user_locations_path)
...
def run_in_terminal_window(autotest, name, cmd):
    print("3.run_in_terminal_window() is called for something!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1!")
...
def start_vehicle(binary, autotest, opts, stuff, loc):
    print(color.BOLD+color.RED+"2.start_vehicle() is called for something!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"+color.END)
    print(color.BOLD+color.RED+"function arguments is %s\n %s\n %s\n" %(opts, stuff, loc)+color.END)
...
progress("Start")
print("first called function is progress(Start)")
...
if cmd_opts.custom_location:
    ...
    print("cmd_opts.laocation() is %s"%cmd_opts.location)
